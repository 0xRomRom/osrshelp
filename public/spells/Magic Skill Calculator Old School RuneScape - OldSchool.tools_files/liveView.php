...
var SekindoClientDetections_URL = function (config) {
	...
	if (this.isPlayerApiActions && !this.isAmpProject && !this.isAmpIframe && !this.isApp) this.playerApiActions();
				...
				var urlDetObj = new SekindoClientDetections_URL({
					url: 'https://live.primis.tech/live/liveView.php?schain=1.0,1!network-n.com,pa_98a54d0d,1&playerApiId=netw0rkN&cbuster=1699372769524&subId=[SUBID_ENCODED]&pubUrl=https%3A%2F%2Foldschool.tools%2Fcalculators%2Fskill%2Fmagic&s=108863&cbuster=1699384080',
					origQString: 'schain=1.0,1!network-n.com,pa_98a54d0d,1&playerApiId=netw0rkN&cbuster=1699372769524&subId=[SUBID_ENCODED]&pubUrl=https%3A%2F%2Foldschool.tools%2Fcalculators%2Fskill%2Fmagic&s=108863',
					placementId: 108863,
					x: 640,
					y: 440,
					videoType: 'sticky',
					...
					isAPI: false,
					debug: 0,
					ci: {"extra":{"schemaVer":"11","os":"Windows","osVersion":"10.0","osVersionMajor":"10","osVersionMinor":"0","deviceManufacturer":"","deviceModel":"","deviceCodeName":"","deviceType":"desktop","browser":"Chrome","browserType":"browser","browserVersion":"118.0.0.0","browserVersionMajor":"118","browserVersionMinor":"0","chromeVersion":"118"},"browser":"chrome","os":"windows","osVer":"","deviceType":"desktop","languages":{"0":"en","2":"nl"},"googlePSI":false},
					isFpCookie: 0,
					geo: 'NL',
					dmaCode: 0,
					dynamicSetup: [],
					...
					customTargetingProperties: {"objectType":"window","objectFunction":"nnads.meta","commitDoubleEncoding":1},
					customPpidMapping: {"objectType":"window.top","objectFunction":"primisPpidValue","logger":"0"},
