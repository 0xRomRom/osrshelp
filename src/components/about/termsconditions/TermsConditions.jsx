import stl from "./TermsConditions.module.css";
      ...
      <div className={stl.mainWrapper}>
        ...
        <div className={stl.policyWrap}>
          ...
          <p>
            ...
            conditions. Do not continue to use OSRS Help if you do not agree to
          ...
          <p>
            We employ the use of cookies. By accessing OSRS Help, you agreed to
            use cookies in agreement with the OSRS Help's Privacy Policy.
          </p>
          ...
          <p>
            Unless otherwise stated, OSRS Help and/or its licensors own the
            intellectual property rights for all material on OSRS Help. All
            intellectual property rights are reserved. You may access this from
            OSRS Help for your own personal use subjected to restrictions set in
            these terms and conditions.
          </p>

          <p>You must not:</p>
          <ul>
            <li>Republish material from OSRS Help</li>
            <li>Sell, rent or sub-license material from OSRS Help</li>
            <li>Reproduce, duplicate or copy material from OSRS Help</li>
            <li>Redistribute content from OSRS Help</li>
          </ul>
          ...
          <p>
            ...
            OSRS Help does not filter, edit, publish or review Comments prior to
            their presence on the website. Comments do not reflect the views and
            opinions of OSRS Help,its agents and/or affiliates. Comments reflect
            the views and opinions of the person who post their views and
            opinions. To the extent permitted by applicable laws, OSRS Help
          ...
          <p>
            OSRS Help reserves the right to monitor all Comments and to remove
          ...
          <p>
            You hereby grant OSRS Help a non-exclusive license to use,
          ...
          <p>
            ...
            visibility of the hyperlink compensates the absence of OSRS Help;
          ...
          <p>
            ...
            sending an e-mail to OSRS Help. Please include your name, your
          ...
          <p>
            No use of OSRS Help's logo or other artwork will be allowed for
